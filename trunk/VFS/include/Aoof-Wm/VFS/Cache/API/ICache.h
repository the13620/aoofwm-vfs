...
#ifndef __AOOFWM_VFS_CACHE_API_ICACHE_H__
# define __AOOFWM_VFS_CACHE_API_ICACHE_H__
		...
		namespace	Cache
	    {
	    	namespace	API
			{
			    ...
			    public:
			       ...
			       * 		caching capabilities, how they may vary
			       * 		for each provider, and how to integrate them.
			       * 		  Stay tuned.
			       */
			    };
			}
...
#endif	// __AOOFWM_VFS_CACHE_API_ICACHE_H__
