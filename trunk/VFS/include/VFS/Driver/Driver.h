...
#ifndef __VFS_DRIVER_DRIVER_H__
# define __VFS_DRIVER_DRIVER_H__

# include <string>

# include <VFS/Driver/API/IDriver.h>
...
namespace	VFS
{
	namespace	Driver
	{
		class	CDriver : public virtual VFS::Driver::API::IDriver
		{
		public:
			CDriver(void);
