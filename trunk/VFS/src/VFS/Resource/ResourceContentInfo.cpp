...
namespace VFS
{
	namespace Resource
	{
		CResourceContentInfo::CResourceContentInfo(const VFS::Resource::API::IResource* pRsrc)
		{
			_pResource = pRsrc;
		}
		...
		const VFS::Resource::API::IResource*	CResourceContentInfo::GetResource(void) const
		{
			return (_pResource);
		}
