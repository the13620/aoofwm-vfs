...
#ifndef __AOOFWM_VFS_RESOURCE_XMLRESOURCE_H__
# define __AOOFWM_VFS_RESOURCE_XMLRESOURCE_H__
...
namespace	AoofWm
{
	namespace	VFS
	{
		namespace	Resource
		{
			class	CXMLResource : public virtual AoofWm::VFS::Resource::CAbstractResource
			{
			public:
...
#endif	// __AOOFWM_VFS_RESOURCE_XMLRESOURCE_H__
