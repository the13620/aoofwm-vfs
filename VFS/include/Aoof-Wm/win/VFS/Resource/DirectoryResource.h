...
#ifndef __AOOFWM_WIN_VFS_RESOURCE_DIRECTORYRESOURCE_H__
# define __AOOFWM_WIN_VFS_RESOURCE_DIRECTORYRESOURCE_H__
...
#endif	// __AOOFWM_WIN_VFS_RESOURCE_DIRECTORYRESOURCE_H__
